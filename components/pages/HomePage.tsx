        ...
        <div className="block">
            ...
            <section id="sectors" className="py-20 lg:py-28" style={{ backgroundColor: "var(--bg-secondary)" }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            { id: "mining", num: "01", image: "/images/sectionmine.jpg", iconSm: <Gem className="w-5 h-5 text-navy-800" strokeWidth={1.5} />, iconBg: "linear-gradient(135deg, #C8962E, #e7b13f)", badgeBg: "bg-gold-500/20 text-gold-600 dark:text-gold-400", title: T("s_mining_title", "Mining & Metals"), desc: T("s_mining_desc", "Responsible extraction and local metal transformation across Africa.") },
                            { id: "realestate", num: "02", image: "/images/immobilier.jpg", iconSm: <Building2 className="w-5 h-5 text-white" strokeWidth={1.5} />, iconBg: "#0D1B2A", badgeBg: "bg-navy-900/10 dark:bg-white/10 text-navy-900 dark:text-white/70", title: T("s_realestate_title", "Real Estate & Construction"), desc: T("s_realestate_desc", "Developing sustainable industrial and urban infrastructure.") },
                            { id: "agriculture", num: "03", image: "/images/agriculture.jpg", iconSm: <Sprout className="w-5 h-5 text-white" strokeWidth={1.5} />, iconBg: "#15803d", badgeBg: "bg-green-500/20 text-green-700 dark:text-green-400", title: T("s_agri_title", "Agriculture & Livestock"), desc: T("s_agri_desc", "Building agro-industrial value chains and food security.") },
                            { id: "industrial", num: "04", image: "/images/consulting.jpg", iconSm: <Brain className="w-5 h-5 text-white" strokeWidth={1.5} />, iconBg: "#935D46", badgeBg: "bg-orange-500/20 text-orange-700 dark:text-gold-400", title: T("s_consult_title", "Industrial Consulting"), desc: T("s_consult_desc", "Strategic advisory and industrial project management.") },
                            { id: "equipment", num: "05", image: "/images/equipement.jpg", iconSm: <Truck className="w-5 h-5 text-white" strokeWidth={1.5} />, iconBg: "#343a40", badgeBg: "bg-slate-500/20 text-slate-700 dark:text-white/70", title: T("s_equip_title", "Equipment & Industrial Solutions"), desc: T("s_equip_desc", "Supply, maintenance and rental of industrial equipment.") },
                        ].map((sector, i) => (
                            <RevealSection key={i}>
            ...
            <section className="py-20 lg:py-28 relative overflow-hidden" style={{ background: "var(--bg-secondary)" }}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <RevealSection className="text-center mb-16">
                        <div className="gold-line mx-auto mb-6" />
                        <h2 className="font-serif text-3xl lg:text-4xl font-semibold tracking-tight mb-4" style={{ color: "var(--text-primary)" }}>{T("value_title", "Why Partner With Anago Group?")}</h2>
                        <p className="text-base max-w-2xl mx-auto opacity-70" style={{ color: "var(--text-secondary)" }}>{T("value_desc", "Three pillars of sustainable value creation across the African continent.")}</p>
                    </RevealSection>
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <RevealSection key={i} className="text-center p-8 rounded-2xl border transition-all duration-300" style={{ background: "var(--card-bg)", borderColor: "var(--border-color)" }}>
                                ...
                                <h3 className="text-xl font-semibold tracking-tight mb-3" style={{ color: "var(--text-primary)" }}>{vp.title}</h3>
                                <p className="text-sm leading-relaxed opacity-70" style={{ color: "var(--text-secondary)" }}>{vp.desc}</p>
                            </RevealSection>
                        ))}
                    </div>
                </div>
